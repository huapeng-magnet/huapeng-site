...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "fobMinNote": "FOB Ningbo is quoted from 50,000 pcs up — below that the RMB 1,500 shipment fee outweighs the magnets, so this tier is EXW only and ships by UPS/DHL express on your own courier account (freight collect).",
    ...
    de: {
      ...
      "fobMinNote": "FOB Ningbo wird ab 50.000 Stück angeboten — darunter übersteigt die Versandpauschale von RMB 1.500 den Warenwert, daher nur EXW; Versand per UPS/DHL-Express auf Ihr eigenes Frachtkonto (Fracht zahlt Empfänger).",
    ...
    es: {
      ...
      "fobMinNote": "FOB Ningbo se cotiza a partir de 50.000 unidades — por debajo, la tarifa de envío de RMB 1.500 supera el valor de los imanes, por lo que solo se cotiza EXW; envío por mensajería express UPS/DHL a su propia cuenta (franqueo a cargo del destinatario).",
    ...
    ko: {
      ...
      "priceReq": "가격 문의",
      "fobMinNote": "FOB 닝보는 50,000개 이상부터 견적합니다 — 그 이하에서는 선적 고정비 RMB 1,500이 자석 가격을 상회하므로 EXW만 적용되며, UPS/DHL 특송으로 귀사 운송 계정으로 발송됩니다(운임 착불).",
      "addToCart": "장바구니에 담기",
      "removeImage": "이미지 삭제",
      "decrease": "감소",
      "increase": "증가",
    ...
    ja: {
      ...
      "fobMinNote": "FOB 寧波は 50,000 個以上からのご案内です — それ未満では出荷固定費 RMB 1,500 が磁石本体の価格を上回るため、EXW のみとなり、UPS/DHL のエクスプレス便でお客様の運送アカウント宛に発送いたします（運賃着払い）。",
      "addToCart": "カートに追加",
      "removeImage": "画像を削除",
      "decrease": "減らす",
      "increase": "増やす",
